...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo ADMINURL; ?>/template/default/images/favicon.ico" type="image/x-icon">
    <link rel="icon" href="<?php echo ADMINURL; ?>/template/default/images/favicon.ico" type="image/x-icon">
