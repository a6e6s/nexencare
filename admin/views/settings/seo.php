    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <form action="<?php echo ADMINURL . '/settings/edit/' . $data['setting_id']; ?>" method="post" enctype="multipart/form-data" accept-charset="utf-8" >
                ...
                <div class="form-group">
                    <label class="control-label" for="settingTitle">الكلمات الدلالية  : </label>
                    <div class="has-feedback">
                        <input type="text" id="tags_1" class="form-control" name="value[meta_keywords]" placeholder="الكلمات الدلالية " value="<?php echo $data['value']->meta_keywords; ?>">
                    </div>
                </div>
                <div class="form-group col-md-12">
                    <label class="control-label">وصف الموقع  : </label>
                    <div class="row">
                        <textarea rows="5" name="value[meta_description]" class="form-control"><?php echo ($data['value']->meta_description); ?></textarea>
                    </div>
                </div>
