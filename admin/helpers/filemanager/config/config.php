...
// setup access key for user login to enable file manager

isset($_SESSION['filemanager']) ? null : die('Access denied');
...
$config = array(
    ...
    */
    ...
    |
    */
    'upload_dir' => SITEFOLDER . MEDIAFOLDER . '/',
    /*
    |--------------------------------------------------------------------------
    ...
    |
    */
    'current_path' => '../../..' . SITEFOLDER . MEDIAFOLDER . '/',
    ...
    */
    ...
    |
    */
    'thumbs_upload_dir' => SITEFOLDER . '/media/thumbs/',
