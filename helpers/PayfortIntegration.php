...
class PayfortIntegration
{
    ...
    public $gatewaySandboxHost = 'https://checkout.payfort.com/';
    public $language = 'ar';

    /**
     * @var string your Merchant Identifier account (mid)
     */
    public $merchantIdentifier = 'BiZjlLxK';

    /**
     * @var string your access code
     */
    public $accessCode = 'PFEiLpPP5luIGAsOyoFy';

    /**
     * @var string SHA Request passphrase
     */
    public $SHARequestPhrase = 'egvierrbvjb';

    /**
     * @var string SHA Response passphrase
     */
    public $SHAResponsePhrase = 'fvywgyswiui';
...
//        return array('form' => $form, 'url' => $gatewayUrl, 'params' => $postData, 'paymentMethod' => $paymentMethod);
        return $postData;
    }
    ...
    public function getRedirectionData($paymentMethod)
    {
        ...
        $postData = array(
            ...
            'return_url' => $this->getUrl('payfortrespond?r=processResponse'),
        );
     ...
     */
    public function getPaymentOptionName($po)
    {
        switch ($po) {
